        ...
        public VehicleInfo InsertSP(VehicleInfo VehicleInfo)

            {
                ...
                try
                {
                    ...
                    con.Open();
                    con.Execute($"exec VehicleInfoInsert '{VehicleInfo.Name}',{VehicleInfo.VehicleNumber},'{VehicleInfo.RCNumber}',{VehicleInfo.OwnerPhNo},'{VehicleInfo.PurchaseDate.ToString("MM-dd-yyyy")}'");
                    con.Close();
            ...
            public IEnumerable<VehicleInfo> GetVehicleInfoSP()
            {
                try
                {
                    ...
                    var con = new SqlConnection(connectionString);
                    con.Open();
                    var selectQuery = $"exec ReadVehicleInfo";
                    var product = con.Query<VehicleInfo>(selectQuery);
                    con.Close();
